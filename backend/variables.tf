variable "app_name" {
  ...
  type = "string"
  default = "test-rn-app-dev-1533"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "test-rn-app-dev-1533.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/test-rn-app-dev-1533/archive/master.tar.gz"
}
